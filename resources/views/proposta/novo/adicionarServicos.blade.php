...
<div data-role="section">        
    <h3>ACRESCENTAR SERVIÇO</h3>
    <h3>Proposta: {{$proposta->nome}}</h3>
    <br>
    ...
    <!-- Serviços -->    
    <h4>Acrescentar Outros</h4>
    {!! Form::open(array('action' => ['PropostaController@adicionaServico', $proposta->id], 'class' => 'form', 'files'=>true)) !!}
